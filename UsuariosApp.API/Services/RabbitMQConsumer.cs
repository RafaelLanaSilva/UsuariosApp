...
namespace UsuariosApp.API.Services
{
    ...
    public class RabbitMQConsumer : BackgroundService
    {
        ...
        public RabbitMQConsumer(IServiceProvider serviceProvider)
        {
            ...
            //definindo a conexão com o servidor de mensageria
            ...
            _model.QueueDeclare(
                ...
                autoDelete: false, //os itens processados na fila não são removidos automaticamente
        ...
        //Método que será executado em tempo real para fazer a leitura conteínua da fila.
